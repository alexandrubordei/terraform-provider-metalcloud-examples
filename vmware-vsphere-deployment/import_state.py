...
# This script is used to recuperate the state from MetalSoft into terraform.
# This is useful for situations where the state cannot be stored across calls to terraform.
